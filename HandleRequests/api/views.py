...
def pre_process(Gender, Age, Occupation, City_Category, Stay_In_Current_City_Years,
    ...
    Stay_In_Current_City_Years_Count = pd.read_csv(base_dir + '/Stay_In_Current_City_Years_Count.csv', index_col=0)['0']

    df = pd.DataFrame([[Gender, Age, Occupation, City_Category, Stay_In_Current_City_Years, Marital_Status,
                       Product_Category_1, Product_Category_2, Product_Category_3, Age_Count[Age], Occupation_Count[Occupation],
